...
import { Container, Box, Typography, Button, Paper, Input, TextareaAutosize, Tooltip, CircularProgress, IconButton, Alert, Modal, Divider } from '@mui/material';
          ...
          <Box display="grid" gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }} gap={4}>
            ...
            <Box mt={2}>
              ...
              <Box mt={2}>
                ...
                <Tooltip title={t('Tooltip3')} disableHoverListener={!(transcription === '')} arrow>
                  <span>
                    <Button
                      variant="contained"
                      sx={{
